...
from app.utils.tag_utils import update_output_details_hstore_tags
...
async def export_tags_excel(
    ...
    if source_type.lower() == "dbr":
        ...
        raise HTTPException(status_code=404, detail="source_type must be 'dbr'")
...
async def import_tags_excel(
    ...
    if import_type == "new":
        ...
        output_detail_objs=list(all_files),
        tag_id=db_tag.id,
