...
from sqlalchemy import Boolean, String, DateTime, BigInteger, Text, Float, Integer, ForeignKey, Index, Enum as SQLEnum
...
class OutputDetail(SQLModel, table=True):
    ...
    reporting_effort_tags: List["ReportingEffortTag"] = Relationship(
