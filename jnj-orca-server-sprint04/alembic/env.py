...
from app.models import user, source, compound, study, database_release, reporting_effort, distribution_list, output_detail, reporting_effort_tag   # ensure models are imported so metadata is populated
